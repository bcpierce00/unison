...
::
    ("running", ("Running Unison", 
     "Running Unison\n\
      ...
      \n\
      \032  Many merge commands, like diff3 for instance, require not only the two\n\
      \032  files  to  be merged, but also a file containing the last synchronized\n\
      \032  version  of  a file. You can ask Unison to keep such specific archives\n\
      \032  for  some  files  for  you by using the backupcurrent preference. This\n\
      \032  preference  is  used  in exactly the same way as backup. When adding a\n\
      \032  path  specification to backupcurrent, Unison will keep a backup of the\n\
      \032  current   synchronized   version  of  all  files  matching  this  path\n\
      \032  specification,  and  update it every time the files are updated in one\n\
      \032  or  both replicas. These backups are kept on both replicas in the same\n\
      \032  place as regular backups are, i.e. according to the backuplocation and\n\
      \032  backupdir  preferences.  They  are  named  like  the original files if\n\
      \032  backupslocation  is  set  to  'central' and otherwise, Unison uses the\n\
      \032  backupprefix and backupsuffix preferences and assumes a version number\n\
      \032  000 for these backups.\n\
      \n\
