\begin{changesfromversion}{2.27.57}
...
\verb|Not_found|   exception (see [Not_found raised in tryCopyMovedFile] errors)
...
\item The Unison project now accepts donations via PayPal. You can find a
