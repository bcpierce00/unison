...
is simply not acceptable for submission to the project*.  This is
implied by the previous requirement that the submitter has permission
to license the code under the project's license, but stated explicitly
because that seems to be necessary.

It is ethically unacceptable to ask humans to review and deal with
code generated by LLMs.  Even if there were no licensing issues,
LLM-generated code would still be unwelcome.
