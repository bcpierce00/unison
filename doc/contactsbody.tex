...
\item {\bf
  \URL{http://groups.yahoo.com/group/unison-hackers}{unison-hackers}} is
...
To subscribe, you can either visit 
  \ONEURL{http://groups.yahoo.com/group/unison-hackers}
  or else send an email to
  {\tt \URL{mailto:unison-hackers-subscribe@groups.yahoo.com}{unison-hackers-subscribe@groups.yahoo.com}}.
\end{itemize}
