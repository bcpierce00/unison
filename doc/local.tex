...
\newif\ifstable  \stablefalse

\input{texdirectives}

\newcommand{\versionprefix}{2.}
\newcommand{\unisonmajorversion}{%
% $Format: "\\versionprefix $ProjectMajorVersion$%"$
\versionprefix 10%
}
\newcommand{\unisonversion}{%
% $Format: "\\versionprefix $ProjectVersion$%"$
\versionprefix 10.12%
}
