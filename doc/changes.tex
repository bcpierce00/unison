\begin{changesfromversion}{2.51.5}
\item NEWS content for 2.52.0 and later is in NEWS.md in the sources
...
\item OS X GUI:
\begin{itemize}
\item \begin{sloppypar} fix crash under Lion, because of problems with the toolbar, using the
